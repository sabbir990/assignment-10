  ...
  return (
    <div className='bg-base-200 lg:px-20 lg:py-32 p-4'>
      <div className='w-full bg-white py-10 px-4 border border-transparent rounded-lg shadow-lg font-playWrite'>
        ...
        <hr />
        <br />
        <form className='font-bold flex-col lg:flex md:flex'>
          <div className='space-y-4'>
            ...
            <div className='space-y-2'>
              ...
              <input type="text" name='spot-name' placeholder='Enter tourist spots name' className='p-2 outline-none border border-[#94a1a8] rounded-md w-full' />
            </div>
            <div className='space-y-2'>
              <label htmlFor="country-name">Country name</label><br />
              <input type="text" name='country-name' placeholder='Enter country name' className='p-2 outline-none border border-[#94a1a8] rounded-md w-full' />
            </div>
            <div className='space-y-2'>
            ...
            <div className='space-y-2'>
              ...
              <input type="text" name='short-description' placeholder='Enter a short description' className='p-2 outline-none border border-[#94a1a8] rounded-md w-full' />
            </div>
            <div className='space-y-2'>
              <label htmlFor="average-cost">Average cost</label><br />
              <input type="number" name='average-cost' placeholder='Enter average cost' className='p-2 outline-none border border-[#94a1a8] rounded-md w-full' />
            </div>
          </div>
          <div className='space-y-4'>
            <div className='space-y-2'>
            ...
            <div className='space-y-2'>
              ...
              <select name="travel-time" className='p-2 outline-none border border-[#94a1a8] rounded-md w-full'>
            ...
            <div className='space-y-2'>
              ...
              <input type="number" placeholder='Enter total visitors per year' name='total-visitors-per-year' className='p-2 outline-none border border-[#94a1a8] rounded-md w-full' />
            </div>
            <div className='space-y-2'>
